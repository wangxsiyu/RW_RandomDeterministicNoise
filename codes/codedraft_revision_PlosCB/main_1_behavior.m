...
suffix = {'','_all'};
%% behavioral plots
plt = W_plt('savedir', '../figures_revision', 'savepfx', 'RanDetNoise', 'isshow', true, ...
...
for gi = 1:2
    ...
    plt.setfig(3:4, 'ylim', {[0, 30] + (gi-1)*[10 10],[-8 12]}, ...
    ...
    plt.ax(2,1);
    plt = EEplot_random(plt, gp{gi}, {'AZcactus', 'AZsand'}, {'left', 'right'});
    plt.ax(2,2);
    plt = EEplot_directed(plt, gp{gi}, 'AZcactus', 'right');
