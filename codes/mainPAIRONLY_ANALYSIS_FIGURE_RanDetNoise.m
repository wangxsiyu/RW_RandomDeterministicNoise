...
opt_game_sub = {'EEpreprocess_game_sub_repeatedpaironly'};
...
W.writetable(game, fullfile(savedir,'data_paironly.csv'));
%% exclude participants
sub0 = readtable('../data/paironly/SUB_EE_blinkCuriosity_2016S.csv', 'Delimiter', ',');
load('../data/paironly/idxsub_EE_blinkCuriosity_2016S.mat');
...
for gi = 1:2
%% model-free plots
    plt.setup_W_plt('fig_dir', '../figures/paironly','fig_suffix', suffix{gi},'fig_projectname', 'RanDetNoise');
...
%% save bayes data
load('../data/paironly/idxsub_exclude.mat');
game = readtable('../data/paironly/data_paironly.csv', 'Delimiter', ',');
...
save('../data/paironly/bayes_2noise.mat', 'bayes_data');
save('../data/paironly/bayes_2noise_all.mat', 'bayes_data_all');
save('../data/paironly/bayes_2noise_paironly.mat', 'bayes_data_paironly');
save('../data/paironly/bayes_2noise_dRonly.mat', 'bayes_data_dRonly');
save('../data/paironly/bayes_2noise_dIonly.mat', 'bayes_data_dIonly');
save('../data/paironly/bayes_2noise_0model.mat', 'bayes_data_0model');
%%
