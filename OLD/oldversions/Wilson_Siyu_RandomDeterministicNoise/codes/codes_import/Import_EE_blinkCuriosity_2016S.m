...
data = W_import.IMPORT_datafiles_subID_yyyymmddTHHMMSS(datadir, filetemplate, importfunc, ...
...
sub2 = W_import.IMPORT_datafiles_subID_yyyymmddTHHMMSS(datadir, filetemplate, importfunc, ...
    str_subID, num_subID, str_datetime, num_datetime, subIDrange);
