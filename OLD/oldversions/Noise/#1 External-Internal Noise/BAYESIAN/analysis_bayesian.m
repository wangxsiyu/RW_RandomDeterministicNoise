classdef analysis_bayesian < handle
    ...
    methods
        ...
        function setup_chain(obj)
            ...
            obj.nsamples = 5000; % How Many Recorded Samples?
            obj.thin = 1;
        end
        function analysis(obj, modelname, params)
            obj.openpool;
            data = obj.data;
            ...
            obj.stats = stats;
            obj.samples = samples;
            save(fullfile(obj.savepath, [modelname '_new2']),'stats','tictoc','modelname');
            save(fullfile(obj.savepath, [modelname '_samples_new2']),'samples','-v7.3');
            obj.closepool;
                 end
