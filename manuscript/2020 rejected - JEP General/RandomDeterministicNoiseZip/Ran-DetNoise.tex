...
\keywords{explore-exploit, decision making, decision noise, behavioral variability, reinforcement learning}
	\normalsize
	...
	\begin{figure}[hp]
		\begin{center}
			\includegraphics[width=\textwidth]{taskfiga.pdf}
			\caption{ 
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=\textwidth]{RanDetNoise_modelfree.png}
			\caption{
	...
	\begin{figure}[h]
		\begin{center}
			\includegraphics[width=\textwidth]{RanDetNoise_2noise.png}
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=1\textwidth]{RanDetNoise_hyperprior.png}
	...
	%\begin{figure}[H]
	%	\begin{center}
%			\includegraphics[width=1\textwidth]{pinconsistent_4panel_age_acchance_2noisemodelA_2noisemodelA.png}
%			\caption{}
%			\label{fig:mb2}
%		\end{center}
%	\end{figure}
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=1\textwidth]{RanDetNoise_2noise_6modelcomparison.png}
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=1\textwidth]{EEHorizon_2sigma.pdf}
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=0.9\textwidth]{RanDetNoise_parameter_recovery1.png}
